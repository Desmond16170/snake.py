...
def message(msg, color, y_displace=0):
    mesg = font_style.render(msg, True, color)
    game_display.blit(mesg, [width/2 - mesg.get_width()/2, height/2 - mesg.get_height()/2 + y_displace])
...
# niveles de juego, basicamente cada vez que se llene la pantalla, se va hacer mas grande la misma,
# 3 niveles nivel 1 con una pantalla pequeña, nivel 2 pantalla mediana
# y nivel 3 con pantalla grande, se pude hacer con una variable que si tamaño de snake == a tamaño de pantalla 
# entonces ejecute nivel 2 () y si llega a nivel 3 poner fin del juego se usaria el mismo codigo cambiando aspecto de tamaño y velocidad del juego 
